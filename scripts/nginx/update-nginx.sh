...
# Script to update Nginx configuration for Sogni Makeover
...
NGINX_CONFIG_DEST="/opt/homebrew/etc/nginx/servers/makeover-local.conf"
...
function show_usage {
  echo "Usage: $0 [--help]"
  echo ""
  echo "Updates the Nginx configuration for Sogni Makeover local development."
...
echo "===== Sogni Makeover Nginx Configuration Update ====="
...
echo "  https://makeover-local.sogni.ai"
echo ""
echo "If you cannot access the site, please check:"
echo "1. Your /etc/hosts file includes '127.0.0.1 makeover-local.sogni.ai'"
