// Service Worker for Sogni AI Makeover PWA - INTELLIGENT CACHING
const CACHE_VERSION = '1.0.24';
const CACHE_NAME = `sogni-makeover-v${CACHE_VERSION}`;
const STATIC_CACHE_NAME = `sogni-makeover-static-v${CACHE_VERSION}`;
